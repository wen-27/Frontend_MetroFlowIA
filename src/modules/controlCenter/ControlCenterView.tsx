...
export const ControlCenterView: React.FC<ControlCenterViewProps> = ({
  ...
  const [newIncLocation, setNewIncLocation] = useState('Sector Provenza');
  const [newIncRoute, setNewIncRoute] = useState('R1');
      ...
      <header className="glass sticky top-0 z-[2000] shadow-sm shrink-0">
        <div className="max-w-7xl mx-auto px-4 py-3 sm:px-6 lg:px-8 flex flex-col md:flex-row md:items-center justify-between gap-3">
          <div className="flex items-center gap-3">
            ...
            <div className="h-6 w-px bg-slate-355" />
            ...
            <div className="flex items-center gap-2">
              <span className="font-extrabold text-lg text-slate-900 tracking-tight flex items-center gap-1.5">
                ...
                <span className="text-[10px] font-bold text-slate-400 font-mono tracking-wider pl-1.5 uppercase hidden sm:inline">// CENTRO_CONTROL</span>
              </span>
            </div>
          </div>
          ...
          <div className="flex items-center gap-2 flex-wrap">
            ...
            >
              <span className="hidden sm:inline">Activar Alerta IA</span>
              <span className="sm:hidden">Alerta IA</span>
            </Button>
      ...
      <main className="max-w-7xl mx-auto px-4 pt-6 sm:px-6 lg:px-8 space-y-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
          ...
          <div className="lg:col-span-8 space-y-6">
            ...
            <div className="bg-white rounded-xl border border-slate-200 p-1 flex overflow-x-auto whitespace-nowrap gap-1 shadow-sm font-sans scrollbar-none [scrollbar-width:none] [-ms-overflow-style:none]">
              <button
            ...
            {/* TAB PANELS: GPS MAP */}
            {mainTab === 'gps' && (
              <Card className="p-5 overflow-hidden animate-slide-up font-sans relative z-10">
